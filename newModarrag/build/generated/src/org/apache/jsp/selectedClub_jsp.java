...
public final class selectedClub_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                <li><a href=\"#\">Home</a></li>\n");
      out.write("                <li><a href=\"#\">club</a></li>\n");
      out.write("                <li class=\"active\">AHLY</li>\n");
      out.write("            </ol>\n");
      out.write("        </div>\n");
      out.write("        ");
            ...
            String sql = "Select * from modarag.team where `teamID` = ?; ";
      ...
      out.write("\n");
      out.write("        <div class=\"container\">\n");
      out.write("            <form action=\"buyTicket.jsp\">\n");
      ...
      out.write("                ");
                    ...
                    sql = "Select * from modarag.match where `firstTeamID` = ? or `secondTeamID` = ?; ";
                    stmt = conn.prepareStatement(sql);
                    stmt.setInt(1, requestedID);
                    stmt.setInt(2, requestedID);
                    ResultSet rs = stmt.executeQuery();
                    String stadiumName, date, firstTeamName, secondTeamName;
                    while (rs.next()) {
                        sql = "Select * from modarag.team where `teamID` = ?; ";
                        stmt = conn.prepareStatement(sql);
                        stmt.setInt(1, rs.getInt(2));
                        ResultSet rs2 = stmt.executeQuery();
                        rs2.next();
                        firstTeamName = rs2.getString(2);
                        sql = "Select * from modarag.team where `teamID` = ?; ";
                        stmt = conn.prepareStatement(sql);
                        stmt.setInt(1, rs.getInt(3));
                        ResultSet rs3 = stmt.executeQuery();
                        rs3.next();
                        secondTeamName = rs3.getString(2);
      ...
      out.write("                        <p class=\"editt\"> ");
      out.print(stadiumName);
      out.write(" & ");
      out.print(date);
      out.write("</p>\n");
      out.write("                    </div>\n");
      out.write("                    <div class=\"col-lg-8 tablle\">\n");
      ...
      out.write("        </div>\n");
      out.write("        <!--<div class=\"row\">\n");
      out.write("          <div class=\"col-lg-12 edit7\">\n");
      out.write("            <img src=\"Zamalek_logo.png\" class=\"img-circle myImg edit\">\n");
      out.write("            <a href=\"Description.html\"> Al ZAMALEK </a>\n");
      out.write("          </div>\n");
      out.write("         </div>\n");
      out.write("         <div class=\"row rowEdit\">\n");
      out.write("          <div class=\"col-lg-5\">\n");
      out.write("           <p class=\"edit edit4\"> Cairo stadium </p>\n");
      out.write("          </div>\n");
      out.write("          <div class=\"col-lg-5\">\n");
      out.write("           <p class=\"edit4 edit\"> Tuesday 20 pm </p>\n");
      out.write("          </div>\n");
      out.write("         </div>\n");
      out.write("        </div>-->\n");
      out.write("        <!-- InstanceEndEditable -->\n");
