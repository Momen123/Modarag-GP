<%-- 
    Document   : refister.jsp
    Created on : Jun 16, 2016, 3:07:18 AM
    Author     : F 16
--%>
...
<p> Welcome to MODARAG </p>
 ...
 <form action="registerationCheck.jsp" name="register" onsubmit="return ValidateForm()">
  <div class="loginpanel">
   <div class="txt">
       <input id="user" type="text" placeholder="Username" name="name" required />
    <label for="user" class="entypo-user"></label>
   </div>
   <div class="txt">
       <input id="pwd" type="password" placeholder="Password" name="pass" required  />
    <label for="pwd" class="entypo-lock"></label>
   </div>
   <div class="txt">
       <input id="Cpwd" type="password" placeholder="conform password" name="cPass" required  />
    <label for="pwd" class="entypo-lock"></label>
  </div>
  <div class="txt">
  ...
  <div class="txt">
      <input id="Gover" type="text"  placeholder="National ID" name="nationalID"  required />
