<%-- 
    Document   : myAccount
    Created on : Jun 25, 2016, 2:00:27 PM
    Author     : F 16
--%>
...
<html><!-- InstanceBegin template="/Templates/masterPage.dwt" codeOutsideHTMLIsLocked="false" -->
    <head>
        ...
        <link href="https://fonts.googleapis.com/css?family=Fjalla+One|Muli|Open+Sans|Work+Sans" rel="stylesheet"><!-- InstanceEndEditable --><!--//------->
        ...
        <div class="account">
            <div class="nested-account">
                ...
                <%
                    ...
                    String sql = "Select * from modarag.user where `userID` = ?; ";
                ...
                <div class="my-Account">
                    <div class="name">
                        <p class="p"> Name: <span class="edit4"><%=rs.getString(3)%></span></p>
                    </div>
                    <div class="name">
                        <p class="p"> email: <span class="edit4"><%=rs.getString(4)%></span></p>
                    </div>
                    <div class="name">
                        <p class="p"> National ID: <span class="edit4"><%=rs.getString(2)%></span> </p>
                    </div>
                </div>
                <a href="editAccount.jsp"><button class="right"> Edit Profile </button></a>
            </div>
        </div>
