<%-- 
    ...
    Created on : Jun 30, 2016, 5:40:47 PM
    Author     : F 16
--%>
 ...
 <div class="nested-meenu">
  ...
  <div class="myAccount fa fa-user">
   <a href="myAccount.jsp">My Account </a>
        ...
        <div class="container">
            <form action="buyTicket.jsp">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <h2 class="text-primary text-center"> <%=rs1.getString(2)%> Matches </h2>
                </div>
                <%
                ...
                <div class="row">
                    <div class="col-lg-2">
                        <p class="editt"> <%=stadiumName%> & <%=date%></p>
                    </div>
                    <div class="col-lg-8 tablle">
                        <div class="col-lg-5">
                           <p> <%=firstTeamName%></p>
                        </div>
                        <div class="col-lg-2">
                    ...
                    <div class="col-lg-2">
                        <input type="submit" name="<%=rs.getInt(1)%>" value="Buy">
                    </div>
                </div>
                <%
                    }
        ...
        <!--<div class="row">
          <div class="col-lg-12 edit7">
            <img src="Zamalek_logo.png" class="img-circle myImg edit">
            <a href="Description.html"> Al ZAMALEK </a>
          </div>
         </div>
         <div class="row rowEdit">
          <div class="col-lg-5">
           <p class="edit edit4"> Cairo stadium </p>
          </div>
          <div class="col-lg-5">
           <p class="edit4 edit"> Tuesday 20 pm </p>
          </div>
         </div>
        </div>-->
        <!-- InstanceEndEditable -->
