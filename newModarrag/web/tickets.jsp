<%-- 
    Document   : tickets
    Created on : Jun 30, 2016, 12:29:28 AM
    Author     : F 16
--%>
  ...
  <div class="myAccount fa fa-user">
   <a href="myAccount.jsp">My Account </a>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <h2 class="text-primary text-center"> YOUR TICKETS </h2>
        </div>
...
<br>
        <div class="container rowEdit">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4">
                    <p class="edit4 edit5">  <%=className%> </p>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-5">
                    <p class="edit4 edit5 right">National ID : <span class="edit4"><%=nationalID%></span>  </p>
                </div>
                <div class="col-lg-4 rig">
                    <p class="edit4 edit5 right">Serial Num : <span class="edit4"><%=serialNumber%></span>  </p>
                </div>
                <div class="col-lg-3 rigg">
                    <p class="edit4 edit5 right">price : <span class="edit4"><%=classPrice%></span></p>
                </div>
            </div>
        </div>
        <%
